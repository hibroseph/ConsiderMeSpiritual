...
public class ExampleUnitTest {
    ...
    // Tests the function incrementPushIdBy1 to make sure the last character increases by 1
    @Test
    public void incrementCharTest() throws Exception {
        ...
        String incrementedString = activity.incrementPushIdBy1(string);
        assertEquals("-LGOEw6muos-OonrZOny", incrementedString);

        // Case 2 Simple name increment
        string = "Joseph";
        incrementedString = activity.incrementPushIdBy1(string);
